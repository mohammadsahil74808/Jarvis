...
try:
    ...
    print("[open_app] ⚠️ psutil not installed. Process tracking/killing disabled.")
    _PSUTIL = False
...
_APP_ALIASES = {
    ...
    "youtube":            {"Windows": "YouTube",                "Darwin": "YouTube",             "Linux": "youtube"},
...
def open_app(
    ...
    if not app_name:
        return "Please specify which application, sir."
